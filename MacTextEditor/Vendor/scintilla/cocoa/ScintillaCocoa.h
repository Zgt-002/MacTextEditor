...
private:
	...
	mutable const Document *characterPositionDocument {};
	mutable std::vector<std::pair<Sci::Position, Sci::Position>> characterPositionCheckpoints;
	mutable Sci::Position lastCharacterPosition {};
	mutable Sci::Position lastCharacterIndex {};

	void ResetCharacterPositionCache() const;
	void EnsureCharacterPositionCache() const;
	void UpdateCharacterPositionCache(const NotificationData &notification);
