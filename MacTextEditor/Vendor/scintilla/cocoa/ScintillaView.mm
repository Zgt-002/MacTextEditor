...
- (NSRange) selectedRange {
	...
	if (posRangeSel.length == 0) {
		...
		NSString *inputSource = tic.selectedKeyboardInputSource;
		...
		if ([inputSource hasPrefix: @"com.apple.inputmethod.SCIM."] ||
			[inputSource hasPrefix: @"com.apple.inputmethod.TCIM."]) {
